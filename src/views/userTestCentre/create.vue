                ...
                <el-col :span="24">
                  ...
                  <el-form-item label="" prop="">
                    <el-radio-group v-if="item.type==='0'" v-model="answers[index]" >
                      <el-radio v-for="option in item.options" :label="option.val" :key="option.val">{{ option.label }}</el-radio>
                    </el-radio-group>
                    <el-checkbox-group v-if="item.type==='1'" v-model="answers[index]" >
                      <el-checkbox v-for="option in item.options" :label="option.val" :key="option.val">{{ option.label }}</el-checkbox>
                    </el-checkbox-group>
                  </el-form-item>
                </el-col>
