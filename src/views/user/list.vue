<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.importance" placeholder="届数" clearable style="width: 90px" class="filter-item">
        <el-option v-for="item in importanceOptions" :key="item" :label="item" :value="item" />
      </el-select>
      <el-select v-model="listQuery.type" placeholder="用户类型" clearable class="filter-item" style="width: 130px">
        <el-option v-for="item in calendarTypeOptions" :key="item.key" :label="item.display_name" :value="item.key" />
      </el-select>
      <el-select v-model="listQuery.type" placeholder="专业" clearable class="filter-item" style="width: 130px">
    ...
    <el-table v-loading="listLoading" :key="tableKey" :data="list" border fit highlight-current-row style="width: 100%;">
      ...
      <el-table-column label="联系电话" width="150px" align="center">
        <template slot-scope="scope">
          ...
          <span>137888888888</span>
        </template>
      </el-table-column>
      <el-table-column label="用户类型" min-width="110px" align="center">
        <template slot-scope="scope">
          <span>学员</span>
        </template>
      </el-table-column>
      <el-table-column label="届数" width="110px" align="center">
        <template slot-scope="scope">
      ...
      <!-- <el-table-column label="激活码" width="80px">
        <template slot-scope="scope">
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="用户类型" prop="type">
          <el-select placeholder="">
            <el-option :key="1" label="学员"/>
          </el-select>
        </el-form-item>
        <el-form-item label="届数" prop="title">
          <el-input v-model="temp.title" />
        </el-form-item>
